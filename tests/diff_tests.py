...
class BasicMetricTesting(unittest.TestCase):
    ...
    def test_add_field(self):
        TestHelper.runTestForTwoVersions(self, 'v1', 'v2', {'#C-': 1, '#C+': 1, 'E': 1, 'FA': 1, 'CC': 1})

    #Initialize the field
    def test_field_init(self):
        TestHelper.runTestForTwoVersions(self, 'v2', 'v3', {'#C-': 1, '#C+': 1, 'R': 1, 'MC': 1, 'CC': 1})

    #Change the field type
    def test_chg_field_type(self):
        TestHelper.runTestForTwoVersions(self, 'v2', 'v4', {'#C-': 1, '#C+': 1, 'C': 1, 'FC': 1, 'CC': 1})

    #Change the field visibility
    def test_chg_field_visibility(self):
        TestHelper.runTestForTwoVersions(self, 'v2', 'v5', {'#C-': 1, '#C+': 1, 'C': 1, 'FC': 1, 'CC': 1})

    #Add a static field
    def test_add_static_field(self):
        TestHelper.runTestForTwoVersions(self, 'v1', 'v6', {'#C-': 1, '#C+': 1, 'E': 1, 'FA': 1, 'CC': 1})

    #Initialize the field
    def test_static_field_init(self):
        TestHelper.runTestForTwoVersions(self, 'v6', 'v7', {'#C-': 1, '#C+': 1, 'E': 1, 'MA': 1, 'CC': 1})

    #Change the field type
    def test_static_field_chg_type(self):
        TestHelper.runTestForTwoVersions(self, 'v6', 'v8', {'#C-': 1, '#C+': 1, 'C': 1, 'FC': 1, 'CC': 1})

    #Change the field visibility
    def test_static_field_chg_visibility(self):
        TestHelper.runTestForTwoVersions(self, 'v6', 'v9', {'#C-': 1, '#C+': 1, 'C': 1, 'FC': 1, 'CC': 1})

    #Method rename
    def test_method_rename(self):
        TestHelper.runTestForTwoVersions(self, 'v1', 'v10', {'#C-': 1, '#C+': 1, 'C': 1, 'MD': 1, 'MA': 1, 'CC': 1})

    #Field rename
    def test_field_rename(self):
        TestHelper.runTestForTwoVersions(self, 'v2', 'v11', {'#C-': 1, '#C+': 1, 'C': 1, 'FD': 1, 'FA': 1, 'CC': 1})

    #Field rename when used at one location
    def test_field_rename_used_1_loc(self):
        TestHelper.runTestForTwoVersions(self, 'v12', 'v13', {'#C-': 1, '#C+': 1, 'C': 1, 'MC': 0, 'FR': 1, 'CC': 1})

    #Method rename when used  at one locations (empty body)
    def test_method_rename_used_1_loc_no_body(self):
        TestHelper.runTestForTwoVersions(self,'v14', 'v15', {'#C-': 1, '#C+': 1, 'C': 1, 'MC': 0, 'MD': 1, 'MA': 1, 'CC': 1})

    #Field rename when used at two locations
    def test_field_rename_used_2_loc(self):
        p = {'#C-': 1, '#C+': 1, 'C': 1, 'MC': 0, 'FR': 1, 'CC': 1}
        TestHelper.runTestForTwoVersions(self,'v16', 'v17', p)
    ...
    def test_delete_all_params_add_del_1m(self):
        ...
        TestHelper.runTestForTwoVersions(self,'v22', 'v23', p)
    ...
    def test_add_del_2m_1f_change_1p(self):
        ...
        TestHelper.runTestForTwoVersions(self,'v24', 'v25', p)

    #Add a new class
    def test_add_1_class(self):
        p = {'#C-': 1, '#C+': 2, 'CA': 1}
        TestHelper.runTestForTwoVersions(self,'v1', 'v26', p)

    #Delete a class
    def test_drop_1_class(self):
        p = {'#C-': 2, '#C+': 1, 'CD': 1}
        TestHelper.runTestForTwoVersions(self,'v26', 'v1', p)

    #Add body lines in a method
    def test_R_extend_1_function(self):
        p = {'#C-': 1, '#C+': 1, 'R': 1, 'MC': 1, 'CC': 1}
        TestHelper.runTestForTwoVersions(self,'v1', 'v27', p)

    #Remove body lines in a method
    def test_R_shrink_1_function(self):
        p = {'#C-': 1, '#C+': 1, 'R': 1, 'MC': 1, 'CC': 1}
        TestHelper.runTestForTwoVersions(self,'v27', 'v1', p)

    #Add a method
    def test_E_add_method(self):
        p = {'#C-': 1, '#C+': 1, 'E': 1, 'MA': 1, 'CC': 1}
        TestHelper.runTestForTwoVersions(self,'v1', 'v28', p)

    #ECR = 1 with three classes
    def test_ECR_1(self):
        p = {'#C-': 3, '#C+': 3, 'E': 1, 'C': 1, 'R': 1, 'MC': 1, 'MD': 1, 'MA': 2, 'CC': 3}
        TestHelper.runTestForTwoVersions(self,'v29', 'v30', p)
